...
# Dias com 0 clientes e/ou 0 vendas
cat("Dias com 0 clientes:", sum(df$Num_Customers == 0), "\n")
cat("Dias com 0 vendas:",   sum(df$Sales == 0), "\n")


# Distribuição e outliers da variável Num_Customers
par(mfrow = c(1, 2))
...
# Correlação entre as variáveis da loja de Richmond
numeric_vars <- df %>%
...
# Série Temporal
# Visualizar tendência, picos e padrões desta loja
