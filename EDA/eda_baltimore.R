...
# Ver dias com 0 clientes e 0 vendas
...
par(mfrow = c(1, 1))
# Outliers não são removidos porque correspondem a eventos reais
...
ggplot(df, aes(DayOfWeek, Num_Customers)) +
  ...
  theme_minimal()
# Verificamos que DayOfWeek é um preditor relevante
